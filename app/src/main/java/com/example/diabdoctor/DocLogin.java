...
public class DocLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSignIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(email.isEmpty()){
                    ...
                    mFirebaseAuth.signInWithEmailAndPassword(email, pwd).addOnCompleteListener(DocLogin.this, new OnCompleteListener<AuthResult>() {
                        @Override
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if(!task.isSuccessful()){
                                Toast.makeText(DocLogin.this,"Login Error, Please Login Again",Toast.LENGTH_SHORT).show();
                            }
                            else{
        ...
        tvSignUp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intSignUp = new Intent(DocLogin.this, DocRegister.class);
